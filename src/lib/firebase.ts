...
let app: FirebaseApp;
let auth: Auth;
let firestore: Firestore; // Adicionada variável Firestore
...
auth = getAuth(app);
firestore = getFirestore(app); // Inicializar Firestore
...
export { app, auth, firestore, analytics }; // Exportar firestore
